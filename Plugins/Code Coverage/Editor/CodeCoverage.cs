...
namespace UnityEditor.TestTools.CodeCoverage
{
    ...
    public static class CodeCoverage
    {
        ...
        /// <summary>
        /// Call this to generate a coverage report without stopping the current recording session.
        /// </summary>
        public static void GenerateReportWithoutStopping()
        {

            GenerateReportWithoutStoppingInternal();
        }

        internal static void GenerateReportWithoutStoppingInternal()
        {
            bool isRunning = CoverageRunData.instance.isRunning;
